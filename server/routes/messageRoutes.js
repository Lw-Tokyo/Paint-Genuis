...
// sanity checks (will print to server console if something missing)
...
// GET /api/messages/:userId -> conversation with that user
...
// GET /api/messages -> list of conversations for logged-in user
